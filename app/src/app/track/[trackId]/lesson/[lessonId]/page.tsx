...
export default function LessonPage() {
  ...
  // Find lesson across all chapters
  let lesson = null;
  let chapterTitle = '';
  ...
  // Build flat list of all lessons for prev/next nav
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative border-b border-card-border">
        ...
        <div className="mx-auto max-w-3xl px-6 py-10 lg:px-8">
          ...
          <nav className="mb-6 flex flex-wrap items-center gap-2 text-sm text-text-muted">
            ...
            <Link href={`/track/${track.id}`} className="hover:text-text-secondary transition-colors" style={{ color: track.color }}>
              {track.title}
            </Link>
            <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" />
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs text-text-muted">
                ...
                {lesson.miniExercises && (
                  <span>{lesson.miniExercises.length} mini exercises</span>
                )}
              </div>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-3xl px-6 py-10 lg:px-8">
        ...
        {lesson.concepts && lesson.concepts.length > 0 && (
          <section className="mb-12">
            <div className="mb-6 flex items-center gap-3">
              ...
              <span className="text-xs text-text-muted">{lesson.concepts.length} concepts</span>
            </div>
        ...
        {lesson.miniExercises && lesson.miniExercises.length > 0 && (
          <section className="mb-12">
            <div className="mb-6 flex items-center gap-3">
              ...
              <span className="text-xs text-text-muted">Progressive disclosure</span>
            </div>
            <div className="space-y-6">
              ...
              {lesson.resources.map((resource, idx) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <span className="block text-sm font-medium text-text-primary group-hover:text-white transition-colors truncate">
                      {resource.label}
                    </span>
        ...
        {/* Why What You Learned Is Important - teal accent */}
        {lesson.whyItMatters && (
